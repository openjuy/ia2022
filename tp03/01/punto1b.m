...
%Proponer un método de defuzzyficación diferente a los estudiados y calcular el valor crisp(defuzzyficación)
%de la función de la figura
...
%el cual genero un valor del centroide de -0.2421, a traves de la función DEFUZZ. El
%calculo del centroide para figuras regulares, aplicando el metodo
%analitico de la teoria dio como resultado : , por lo que el error
%cuadratico es muy pequeño.
%El grupo propuso como metodo de defuzzyficación, el calculo del centroide
%para una figura triangular que coincide con el universo de la funcion
%implicada y agregada, este calcuolo dio como resultado el centroide del
%triangulo igual a = -1.1449e-18 y comparado al centroide de la figura de
%la funcion implicada es muy aproximada, generando un ECM=0.0586, por lo
%que consideramos que podria ser un metodo aceptable.
